...
/**
 *  The CardinalDirection class controls the gestures and the corresponding change in direction.
 */
...
/**
 *  The SwipeManager class controls the gestures and their corresponding actions/results on the player
 */
